% General comments from Jeremy
% ============================

% A number of your references (e.g. EffectOfCompilerOptimizationsOnPentium4
% need converting to short form.
...
% Do you need a forward reference to the discussion of the inadequacies of
% simulating energy consumption below?
...
% There is also the general issue that simulators have to make assumptions
% about energy consumption in the platform, and so are potentially pre-judging
% any results.
...
% Explain what R is (actually I didn't realize [R] was a reference when
% looking at the PDF. A proper reference would help!
