...
Other approaches have looked at genetic algorithms for optimization selection\cite{Lin2008} and optimization phase ordering\cite{}. While these techniques are shown to be effective, they have the drawback that the reasons behind the optimization's select is non-obvious.
